...
#define MaxEvent 40
    ...
    public:
        ...
        virtual SocketType GetSocket() const { return 0; }

        void DeleteSocket(SocketType fd);
        bool AddSocket(SocketType fd, const std::string& ipport);
    ...
    protected:
        ...
        void DeleteSocketNoLock(SocketType fd);
